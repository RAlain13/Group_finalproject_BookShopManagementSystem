          ...
          <div class="col-mid-4" style="width:300px">
              <div class="mb-3">
                  <label for="" class="form-label text-success">Author Name</label>
                   <input type="text" placeholder="Author's Name" autocomplete="off" class="form-control" runat="server" id="ANameTb" style="width:300px"/>
              </div>
              <div class="mb-3">
                  <label for="" class="form-label text-success">Author Gender</label>
                  <asp:DropDownList runat="server"  class="form-control" id="GenCb" style="width:300px">
              ...
              <div class="mb-3">
                  ...
                  <asp:DropDownList ID="CountryCb" runat="server"  class="form-control"  style="width:300px">
